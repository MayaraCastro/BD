...
public class Guia extends Pessoa{
	...
	public Guia(String nome, LocalDate dt_nasc, String sexo, String fone, byte[] foto, String cep, Integer num,
	...
	public Guia(Integer cod, String nome, LocalDate dt_nasc, String sexo, String fone, byte[] foto, String cep,
	...
	public Guia(Float salario, Integer ramal, String cPF,Integer cod, String cod_Agencia) {
		super(cod);
		this.salario = salario;
		this.ramal = ramal;
		CPF = cPF;
